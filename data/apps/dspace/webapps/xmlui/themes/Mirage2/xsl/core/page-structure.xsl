...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHeader">
        ...
        <header>
			...
			<a href="{$context-path}/" class="navbar-brand">
                       	   <h1 class="nav navbar-nav pull-left">
        ...
        <footer>
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-8">
                        <div>
                            <a href="http://www.dspace.org/" target="_blank">DSpace software</a> copyright&#160;&#169;&#160;2002-2023&#160; <a href="http://www.duraspace.org/" target="_blank">DuraSpace</a>
                        </div>
                        <div class="hidden-print">
                            
			<a href="http://mendelu.cz" target="_blank">Mendel University in Brno</a> | <a href="http://knihovna.mendelu.cz" target="_blank">Library</a> | copyright&#160;&#169;&#160;2002-2023&#160;
			   ...
			   <!-- <a>
			    ...
			    <a title="Base" target="_blank" href="https://www.base-search.net/about/en/">
                                <img alt="BASE" src="{concat($theme-path, 'images/base.gif')}"/>
                            </a>
                        </div>
                    </div>
